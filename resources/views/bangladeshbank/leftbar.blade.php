...
<div class="sidebar d-none d-md-block bg-info text-white">
    ...
    <h3 style="font-size: 20px; font-weight: bold; margin-top: 60px; margin-bottom: 30px;">Insurance Authority</h3>
    ...
    <a class="text-warning hover:text-info" href="{{ url('/bangladeshBank/bankregister') }}"
        ...
        Register Insurance</a>
    
    <a class="text-warning hover:text-info" href="{{ url('bangladeshBank/branchlist') }}"
        style="font-size: 15px; font-weight: 500; text-decoration:none; {{ Request::is('bangladeshBank/branchlist') ? 'background-color: #ddd; color: blue;' : '' }}">Agent</a>

        <a class="text-warning hover:text-info" href="{{ url('bangladeshBank/banklist') }}"
        style="font-size: 15px; font-weight: 500; text-decoration:none; {{ Request::is('bangladeshBank/banklist') ? 'background-color: #ddd; color: blue;' : '' }}">Insurance Company</a>
